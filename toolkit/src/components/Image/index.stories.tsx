...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://pancakeswap.finance/images/tokens/${token.address[43114]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `/images/coins/${token.address[43114]}.svg`;
        const secondarySrc = `/images/coins/${tokens[randomTokenIndex].address[43114]}.svg`;
