...
var Default = function () {
    return (React.createElement(NotificationDot_1.default, { show: true },
        React.createElement(Button_1.default, null, "Hi")));
};
...
var MenuButtons = function () {
    ...
    return (React.createElement(Row, null,
        React.createElement(ButtonMenu_1.default, { activeIndex: index, onItemClick: handleClick },
            React.createElement(NotificationDot_1.default, { show: index === 0 },
                React.createElement(ButtonMenuItem_1.default, null, "Button 1")),
            React.createElement(NotificationDot_1.default, { show: index === 1 },
                React.createElement(ButtonMenuItem_1.default, null, "Button 2")),
            React.createElement(NotificationDot_1.default, { show: index === 2 },
                React.createElement(ButtonMenuItem_1.default, null, "Button 3")),
            React.createElement(NotificationDot_1.default, { show: index === 3 },
