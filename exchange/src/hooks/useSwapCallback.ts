...
function useSwapCallArguments(
  ...
  return useMemo(() => {
    ...
    //const originalNumerator = trade.inputAmount.numerator;
    //if(currencyEquals(trade.inputAmount.currency, GAME)) trade.inputAmount.numerator = JSBI.BigInt(amountInWithTax.toString());
    ...
    // if(trade.tradeType === TradeType.EXACT_INPUT && currencyEquals(trade.inputAmount.currency, GAME))
    // {
    //     trade.inputAmount.numerator = originalNumerator;
    //     swapMethods[0].args[1] = toHex(trade.inputAmount);
    //     swapMethods[1].args[1] = swapMethods[0].args[1];
    // }
...
export function useSwapCallback(
  ...
  const { account, chainId, library } = useActiveWeb3React()
    ...
    //TODO: If fee detected and From is estimated, don't allow swap.
