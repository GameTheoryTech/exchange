import { Currency, ETHER, Token } from '@gametheory/sdk'
import React, { KeyboardEvent, RefObject, useCallback, useContext, useEffect, useMemo, useRef, useState } from 'react'
import { Text, CloseIcon } from '@gametheory/uikit'
...
export function CurrencySearch({
  ...
  const showETH: boolean = useMemo(() => {
    ...
    return s === '' || s === 'a' || s === 'av' || s === 'ava' || s === 'avax'
  }, [searchQuery])

  const tokenComparator = useTokenComparator(invertSearchOrder)

  const audioPlay = false;// useSelector<AppState, AppState['user']['audioPlay']>((state) => state.user.audioPlay)
